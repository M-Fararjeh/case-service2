...
import com.edigitpath.caze.service.CategoryService;
...
public class CategoryResource {
    ...
    public ResponseEntity<List<CategoryDTO>> getAllCategories(Pageable pageable, @RequestParam(required = false) String filter) {
        if ("cazetype-is-null".equals(filter)) {
            log.debug("REST request to get all Categorys where cazeType is null");
            return new ResponseEntity<>(categoryService.findAllWhereCazeTypeIsNull(),
                    HttpStatus.OK);
        }
