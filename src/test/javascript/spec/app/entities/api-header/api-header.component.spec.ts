...
import { ApiHeaderComponent } from 'app/entities/api-header/api-header.component';
...
describe('Component Tests', () => {
    describe('ApiHeader Management Component', () => {
        let comp: ApiHeaderComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ApiHeaderComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.apiHeaders[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
